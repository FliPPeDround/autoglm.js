...
/**
 * Chinese messages for the agent.
 */
export const MESSAGES_ZH = {
  ...
  api: 'API',
  step: '步骤',
  max_steps_reached: '已达到最大步骤数',
  system_check: '系统检查',
  model_check: '模型检查',
  adb_installed: 'ADB 已安装',
  adb_not_installed: 'ADB 未安装',
  device_connected: '设备已连接',
  no_device_connected: '无设备连接',
  adb_keyboard_installed: 'ADB Keyboard 已安装',
  adb_keyboard_not_installed: 'ADB Keyboard 未安装',
  api_connected: 'API 连接成功',
  api_connection_failed: 'API 连接失败',
  app_launched: '应用已启动',
  app_not_found: '应用未找到',
  tap_executed: '点击已执行',
  type_executed: '输入已执行',
  swipe_executed: '滑动已执行',
  back_executed: '返回已执行',
  home_executed: '返回桌面已执行',
  long_press_executed: '长按已执行',
  double_tap_executed: '双击已执行',
  wait_executed: '等待已执行',
  takeover_requested: '请求人工接管',
  json_parse_error: 'JSON解析错误',
  json_format_error: 'JSON格式错误',
  invalid_response_type: '无效的响应类型',
  missing_required_field: '缺少必需字段',
  invalid_parameter_format: '参数格式无效',
}
